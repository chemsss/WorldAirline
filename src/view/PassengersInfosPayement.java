...
public class PassengersInfosPayement extends javax.swing.JFrame {
    ...
    public PassengersInfosPayement(ArrayList<Flight> selectedFlight, int numberOfPassengers) {
    ...
    public PassengersInfosPayement(ArrayList<Flight> selectedFlight, int numberOfPassengers, CustomerAccount loggedInCustomer) {
