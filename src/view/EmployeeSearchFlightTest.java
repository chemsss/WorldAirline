 ...
 * @author bibes
 */
public class EmployeeSearchFlightTest extends javax.swing.JFrame {

    /**
     * Creates new form SearchFlight
     */
    public EmployeeSearchFlightTest() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeSearchFlightTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeSearchFlightTest().setVisible(true);
            }
        });
    }
